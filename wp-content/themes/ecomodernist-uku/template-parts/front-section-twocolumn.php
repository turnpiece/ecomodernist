...
if ('' != get_theme_mod( 'uku_front_section_one_tag' )) {
	$posttag = array( $posttag );
	$posttag[] = -1 * intval( get_theme_mod( 'uku_front_section_one_tag' ) );
}

if ('' != get_theme_mod( 'uku_front_section_one_cat' )) {
	$postcat = array( $postcat );
	$postcat[] = -1 * intval( get_theme_mod( 'uku_front_section_one_cat' ) );
}

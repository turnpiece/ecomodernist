<?php
/**
 * Implement a custom logo for Ecomodernist
 *
...
function ecomodernist_custom_header_setup() {
	$args = array(
		'default-image'          => '',
		...
		'flex-width'             => false,
		'flex-height'            => true,
		'wp-head-callback'       => 'ecomodernist_header_style',
	);

	add_theme_support( 'custom-header', $args );

}
add_action( 'after_setup_theme', 'ecomodernist_custom_header_setup', 11 );

/**
 * Style the header text displayed on the blog.
 */
function ecomodernist_header_style() {
	...
	?>
	<style type="text/css" id="ecomodernist-header-css">
	<?php

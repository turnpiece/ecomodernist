...
<?php
$postnumber = get_theme_mod('ecomodernist_front_section_twocolumn_number');
$posttag = get_theme_mod('ecomodernist_front_section_twocolumn_tag');
$tag_link = get_tag_link( $posttag );
$postcat = get_theme_mod('ecomodernist_front_section_twocolumn_cat');
$category_link = get_category_link($postcat);

$ecomodernist_section_twocolumn_query = new WP_Query( array(
		...
		<?php while($ecomodernist_section_twocolumn_query->have_posts()) : $ecomodernist_section_twocolumn_query->the_post() ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<?php if ( 'serif' == get_theme_mod( 'ecomodernist_main_design' ) && '' != get_the_post_thumbnail() && ! post_password_required() ) : ?>
					<div class="entry-thumbnail fadein"><a href="<?php the_permalink(); ?>"><span class="thumb-wrap"><?php the_post_thumbnail('ecomodernist-neo-blog'); ?></span></a></div><!-- end .entry-thumbnail -->
				<?php elseif ( '' != get_the_post_thumbnail() && ! post_password_required() ) : ?>
					<div class="entry-thumbnail fadein"><a href="<?php the_permalink(); ?>"><span class="thumb-wrap"><?php the_post_thumbnail('ecomodernist-front-big'); ?></span></a></div><!-- end .entry-thumbnail -->
				<?php endif; ?>

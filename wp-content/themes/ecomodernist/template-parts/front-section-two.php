...
<?php
$posttag = get_theme_mod('ecomodernist_front_section_two_tag');
$tag_link = get_tag_link( $posttag );

$postcat = get_theme_mod('ecomodernist_front_section_two_cat');
$category_link = get_category_link($postcat);

$ecomodernist_section_two_first_query = new WP_Query( array(
	'posts_per_page'				=> 1,
	'post_status'						=> 'publish',
	'tag_id' 								=> $posttag,
	'cat' 									=> $postcat,
...
<section id="front-section-two" class="front-section cf">
	...
	<div class="section-two-column-two columns-wrap">
		<?php if($ecomodernist_section_two_second_query->have_posts()) : ?>
			<?php while($ecomodernist_section_two_second_query->have_posts()) : $ecomodernist_section_two_second_query->the_post() ?>

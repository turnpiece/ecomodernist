...
<article id="post-<?php the_ID(); ?>" <?php post_class($custom_class); ?>>
		...
		<header class="entry-header cf">
			<?php if ( $custom_class != 'no-thumb' && $custom_class == 'big-thumb' && '' != get_the_post_thumbnail() && ! post_password_required() ) : ?>
				<div class="entry-thumbnail">
					<?php the_post_thumbnail('ecomodernist-bigthumb'); ?>
			...
			<div class="entry-meta cf">
				<div class="meta-columnone">
					<div class="author-pic">
						<?php
						$author_bio_avatar_size = apply_filters( 'ecomodernist_author_bio_avatar_size', 100 );
		...
		<div class="contentwrap">
			<?php if ( $custom_class != 'big-thumb' && $custom_class != 'no-thumb' &&  'serif' != get_theme_mod( 'ecomodernist_main_design' ) && '' != get_the_post_thumbnail() && ! post_password_required() ) : ?>
				<div class="entry-thumbnail">

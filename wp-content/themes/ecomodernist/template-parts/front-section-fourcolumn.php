...
<?php
$postnumber = get_theme_mod('ecomodernist_front_section_fourcolumn_number');
$posttag = get_theme_mod('ecomodernist_front_section_fourcolumn_tag');
$tag_link = get_tag_link( $posttag );

$postcat = get_theme_mod('ecomodernist_front_section_fourcolumn_cat');
$category_link = get_category_link($postcat);

$ecomodernist_section_fourcolumn_query = new WP_Query( array(

...
<body <?php body_class(); ?>>
	...
	<header id="masthead" class="site-header cf" role="banner">
		...
		<div class="site-header-content">
			...
			<?php if ( '' == get_theme_mod( 'ecomodernist_main_design' ) || 'standard' == get_theme_mod( 'ecomodernist_main_design' ) ) : ?>
				<nav id="desktop-navigation" class="desktop-navigation cf" role="navigation">
					<?php wp_nav_menu( array( 'theme_location' => 'primary', 'container' => false,)); ?>
				</nav><!-- .main-navigation -->
			<?php endif; ?>
		...
		<div class="sticky-header hidden">
			...
			<?php if (has_nav_menu( 'social' ) && 'serif' != get_theme_mod( 'ecomodernist_main_design' ) ) : ?>
	...
	<?php if ( 'serif' == get_theme_mod( 'ecomodernist_main_design' )  && is_front_page() &&  get_header_image() ) : ?>
		<div id="headerimg-wrap" style="background-image:url(<?php header_image(); ?>);">

				<?php if ( ! '' == get_theme_mod( 'ecomodernist_custom_header_intro' )) : ?>
					<div class="header-intro-wrap">
						<p class="header-intro-text"><?php echo wp_kses_post( get_theme_mod( 'ecomodernist_custom_header_intro' ) ); ?></p>

...
( function($) {
	...
	var $body = $( 'body' ),
		...
		ukuNeo = $body.hasClass( 'ecomodernist-neo' ),
		ukuSerif = $body.hasClass( 'ecomodernist-serif' ),
		headerOffset,
		menuTop = 0,
		resizeTimer;
	...
	// Fade In Animations (Ecomodernist Neo, Standard)
	$('.fadein').viewportChecker({
		classToAdd: 'inview', // Class to add to the elements when they are visible
		removeClassAfterAnimation: false
	});

	// Fade + SlideIn In Animations (Ecomodernist Serif)

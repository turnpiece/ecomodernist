...
// Project related.
var project                 = 'Pukeko'; // Project Name.
...
// Translation related.
var text_domain             = 'pukeko'; // Your textdomain here.
var translationFile         = 'pukeko.pot'; // Name of the transalation file.
var translationDestination  = './languages' // Where to save the translation files.
var packageName             = 'pukeko'; // Package name.
var bugReport               = 'https://elmastudio.de/en/contact/'; // Where can users report bugs.
var lastTranslator          = 'Ellen Bauer <ellen.bauer@elmastudio.de>'; // Last translator Email ID.
var team                    = 'WPTie <ellen.bauer@elmastudio.de>'; // Team's Email ID.
...
// Watch files paths.
var styleWatchFiles         = './assets/sass/**/*.scss'; // Path to all *.scss files inside sass folder and inside them.
